  ...
  const skills = [
    {
      skill: "HTML",
      level: "expert",
      icon: <Html5Icon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "CSS",
      level: "expert",
      icon: <Css3Icon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "JavaScript",
      level: "expert",
      icon: <JSIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "Nest Js",
      level: "Intermediate",
      icon: <NestJsIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "Next Js",
      level: "Intermediate",
      icon: <NextJSIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "Node Js",
      level: "Intermediate",
      icon: <NodeJsIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      skill: "React Js",
      level: "Expert",
      icon: <ReactJsIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />,
      description:
    ...
    },
    {
      ...
      level: "Expert",
      icon: (
        <TailwindCssIcon className="w-10 h-10 md:w-24 md:h-24 fill-blue-400" />
      ),
      description:
    ...
    <div className="flex flex-col gap-2 py-2 mx-5" id="Skills">
      {skills.map((skill, index) => (
        <Card className="!p-0 flex !bg-gray-800 " key={index}>
          <div className="flex items-center flex-1 gap-10 p-10 pr-10 text-blue-400 md:gap-5 md:p-14">
          ...
          <Card className="!bg-blue-400 flex-1 md:flex items-center flex-col justify-center hidden">
